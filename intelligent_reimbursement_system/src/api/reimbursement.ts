...
export const updateReimbursementStatus = (id: string, params: UpdateStatusParams) =>
...
export const exportReimbursementsExcel = (params?: ReimbursementListParams & { categories?: string[] }) => {
  // 多类型转逗号分隔传给后端
  ...
  return http.get('/reimbursements/export', {
    params: queryParams,
    responseType: 'blob',
  }).then((blob: Blob) => {
